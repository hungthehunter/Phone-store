...
//    	navbar_panel.setBackground(woodColor); 	
//		navbar_panel.setBounds(0, 0, 400, 845);
//		navbar_panel.setOpaque(true);
...
//	
//
//		Customer_button.setBackground(offWhite);
...
//		Customer_button.setFocusPainted(false);
...
//	
//		
//		Invoice_button.setBackground(offWhite);
...
//		Invoice_button.setFocusPainted(false);
...
//		
//			counterParty_button.setBackground(offWhite);
...
//			counterParty_button.setFocusPainted(false);
...
//		
//			staff_button.setBackground(offWhite);
...
//			staff_button.setFocusPainted(false);
...
//		
//			salary_button.setBackground(offWhite);
...
//			salary_button.setFocusPainted(false);
...
//		
//			products_button.setBackground(offWhite);
...
//			
//			statistics_button.setBackground(offWhite);
...
//		
//			director_button.setBackground(offWhite);
...
//			director_button.setFocusPainted(false);
...
//		                     /*===== Resize Sidebar =====*/
//		     		            	
//	    		                 int sidebarPanelWidth = (int) (0.275 * newWidth);
...
//	    		                 int sidebarButtonWidth = (int) (0.25 * newWidth_sidebar_button);
//	    		                int sidebarButtonPictureHeight=(int)(0.22 * newHeight_sidebar_button);
...
public class Menu extends JFrame {
	...
	public Menu() {
		...
		Color customColor = new Color(200, 174, 125);
		navbar_panel.setBackground(customColor);
...
//			products_button.addActionListener(new ActionListener() {
//				public void actionPerformed(ActionEvent e) {
//	              Product categoryFrame=new Product();
//	              categoryFrame.setSize(1110,856);
//	              contentPanel.removeAll();
//	              contentPanel.add(categoryFrame);
//	          	  contentPanel.revalidate();
...
//		                 
    ...
    public void createMenuButton(JPanel panel, String text) {
        ...
        Image scaledImage = iconImage.getScaledInstance(45, 36, Image.SCALE_SMOOTH);
        ImageIcon icon = new ImageIcon(scaledImage);

        JButton button = new JButton(text, icon);
        button.setBackground(new Color(200, 174, 125));
        button.setFont(new Font("Verdana", Font.BOLD, 12));
        button.setHorizontalAlignment(SwingConstants.LEFT);
        button.setBorder(new MatteBorder(0, 0, 1, 0, new Color(118, 88, 39)));
        button.setPreferredSize(new Dimension(250, 41));
...
//            Category categoryFrame=new Category();
//            testPanel categoryFrame=new testPanel();
//        Staff  categoryFrame = new Staff();
        Customer categoryFrame=new Customer();
//            categoryFrame.setSize(1110,856);
//            categoryFrame.setBackground(new Color(0xEA, 0xC6, 0x96));
            contentPanel.removeAll();
            contentPanel.add(categoryFrame);
        	contentPanel.revalidate();
        	contentPanel.repaint();
