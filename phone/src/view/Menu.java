...
public class Menu extends JFrame {
		...
		public Menu() {
			...
			Image my_email=Toolkit.getDefaultToolkit().createImage(Menu.class.getResource("/planet.jpg"));//
			...
			Image my_customer=Toolkit.getDefaultToolkit().createImage(Menu.class.getResource("/Icon/customer_picture.png"));//
