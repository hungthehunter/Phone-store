...
//			Image my_customer=Toolkit.getDefaultToolkit().createImage(Menu.class.getResource("Assets/Icon/customer_picture.png"));//
...
//			Image my_add=Toolkit.getDefaultToolkit().createImage(Menu.class.getResource("/Icon/add.png"));//
		    Image my_add = new ImageIcon("Assets/Icon/add.png").getImage();
			Image add_pic=my_add.getScaledInstance(45, 36, Image.SCALE_SMOOTH);
			ImageIcon add_icon=new ImageIcon(add_pic);
			
//			Image my_accept=Toolkit.getDefaultToolkit().createImage(Menu.class.getResource("/Icon/accept.png"));//
		    Image my_accept = new ImageIcon("Assets/Icon/accept.png").getImage();
			Image accept_pic=my_accept.getScaledInstance(45, 36, Image.SCALE_SMOOTH);
			ImageIcon accept_icon=new ImageIcon(accept_pic);
			
//			Image my_delete=Toolkit.getDefaultToolkit().createImage(Menu.class.getResource("/Icon/delete.png"));//
		    Image my_delete = new ImageIcon("Assets/Icon/delete.png").getImage();
			Image delete_pic=my_delete.getScaledInstance(45, 36, Image.SCALE_SMOOTH);
			ImageIcon delete_icon=new ImageIcon(delete_pic);
			
//			Image my_clear=Toolkit.getDefaultToolkit().createImage(Menu.class.getResource("/Icon/clear.png"));//
		    Image my_clear = new ImageIcon("Assets/Icon/clear.png").getImage();
			Image clear_pic=my_clear.getScaledInstance(45, 36, Image.SCALE_SMOOTH);
			ImageIcon clear_icon=new ImageIcon(clear_pic);
			
//			Image my_customer_header=Toolkit.getDefaultToolkit().createImage(Menu.class.getResource("/Icon/customer_picture.png"));/
		    Image my_customer_header = new ImageIcon("Assets/Icon/customer_picture.png").getImage();
